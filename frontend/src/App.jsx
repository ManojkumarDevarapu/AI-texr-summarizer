...
// - Development (your laptop) → localhost
// - Production (Vercel) → Render backend URL
const API_URL =
  import.meta.env.MODE === 'development'
    ? 'http://localhost:5000'
    : 'https://ai-texr-summarizer.onrender.com';
  ...
  const handleSummarize = async () => {
    ...
    try {
      ...
      if (err.code === 'ECONNABORTED') {
        setError('Request timed out. The text might be too long or the server is busy.');
      } else if (err.response) {
        setError(err.response.data.error || 'An error occurred during summarization');
      } else if (err.request) {
        // No more localhost message for users
      ...
      <div className="container">
        ...
        <div className="input-section">
          ...
          <div className="char-count">
            Characters: {text.length} / 10000 | Words:{' '}
